...
class _LavaLampBackgroundState extends State<LavaLampBackground>
  ...
  static final List<BlobData> _blobs = [
    BlobData(
      color: const Color(0x99FFB6C1), // lavaBlob1 with 0.6 alpha
      baseX: 0.25,
      baseY: 0.35,
      radiusX: 0.38,
      radiusY: 0.28,
    ...
    BlobData(
      color: const Color(0x80FF80AB), // lavaBlob2 with 0.5 alpha
      baseX: 0.7,
      baseY: 0.25,
      radiusX: 0.32,
      radiusY: 0.38,
    ...
    BlobData(
      color: const Color(0x80FFE4E1), // lavaBlob3 with 0.5 alpha
      baseX: 0.5,
      baseY: 0.72,
      radiusX: 0.42,
      radiusY: 0.32,
